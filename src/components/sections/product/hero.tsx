  ...
  return (
    <section className="text-charcoal flex flex-col px-6 pt-16 pb-20 lg:px-30 lg:pt-24 lg:pb-28">
      <div className="flex max-w-[36rem] flex-col gap-6">
        ...
        <p className="text-moss-ink font-serif text-[clamp(1.15rem,1vw+0.85rem,1.45rem)] italic">
          {sku.latin}
        </p>
        <p className="text-charcoal/85 max-w-[30rem] font-serif text-[clamp(1.15rem,1vw+0.85rem,1.45rem)] leading-normal">
          {sku.heroSub}
        </p>
        <div className="mt-4 flex flex-wrap items-center gap-6">
          <Link
            href="#buy"
            className="bg-moss-ink text-bone border-moss-ink border px-8 py-4 font-sans text-[15px] font-medium"
          >
            {heroCtaLabel(sku)}
          </Link>
          <span className="text-charcoal/55 font-sans text-[13px] tracking-wide">
