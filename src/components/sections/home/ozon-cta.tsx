...
export function OzonCta() {
  ...
  return (
    <section className="bg-charcoal text-bone flex flex-col items-center gap-7 px-6 py-24 text-center lg:py-32">
      ...
      <h2 className="max-w-[18ch] font-serif text-[clamp(1.9rem,2.6vw+1rem,3rem)] font-light leading-tight">
        {ozonCta.title}
      </h2>
      <OzonButton
        href={ozonStoreUrl}
      ...
      />
      <p className="text-bone/60 max-w-[38rem] font-serif text-[15px] leading-relaxed">
        {ozonCta.caption}
      </p>
    </section>
  );
