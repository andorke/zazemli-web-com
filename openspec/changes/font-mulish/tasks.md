...
- [x] 2.1 Добавить в `globals.css` переменные трекинга: display-hero −0.035em, display-product −0.032em, display-page −0.03em, h1 −0.028em, h2 −0.024em, take/lead −0.02em, eyebrow +0.2em; body/small/caption 0
- [x] 2.2 Применить токены трекинга к заголовочным ролям и eyebrow в компонентах (нулевой трекинг на display/h1/h2 недопустим)
- [x] 2.3 Сверить веса крупных заголовков с прототипами (300–400, не 600); h2 — кеглем h1, отдельного токена нет
