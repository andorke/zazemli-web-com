...
- [ ] 1.1 Получить Mulish variable (roman + italic, OFL) и субсетнуть cyrillic+latin+пунктуация с сохранением оси wght: `src/fonts/mulish-var.woff2` (300–600), `src/fonts/mulish-var-italic.woff2` (300–400)
