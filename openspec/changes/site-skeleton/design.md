...
- **Заголовок галереи SKU** (нода 185:41): не успел выгрузиться до Figma rate limit (429, сброс ~4 дня). Секция собрана с кикером IV + декоративной «7» + 7 карточек + линк, без выдуманного заголовка. Сверить заголовок после сброса лимита.
