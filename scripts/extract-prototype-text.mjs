// Выгрузка видимых текстовых узлов прототипов гайда (вход + два маршрута) и
// lab.html как эталон для контент-тестов (diff-сверка переноса в
// src/content/*.ts против прототипа).
//
